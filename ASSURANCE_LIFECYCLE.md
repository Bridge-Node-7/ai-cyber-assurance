...
Begin with [Start Here](START_HERE.md) and create the [Review Package Index](02-evidence-manifests/review-package-index-template.md). For a focused review, use the Quick Review path. Automated review assistance should also follow [AUTOMATED_REVIEW_GUIDE.md](AUTOMATED_REVIEW_GUIDE.md).
...
| Assets and dependencies | What must remain confidential, accurate, available, authentic, and recoverable? | [Evidence Manifest](02-evidence-manifests/evidence-manifest-template.md) | [Supply Chain Review](06-software-supply-chain/sbom-readiness.md), [Cryptographic Change Assurance](12-cryptographic-change-assurance/README.md) | Critical assets and external dependencies have owners |
